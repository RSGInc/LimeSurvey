...
class Tokens_dynamic extends LSActiveRecord
{
	...
	public function primaryKey()
	{
        ...
        public static function summaries($sids)
        {
            foreach($sids as $sid) 
            {
                $stats = self::classSummary($sid);
                $aData[$sid] = $stats; # array_merge(array('sid'=>$sid), $stats);
            }
            return $aData;
        }
        ...
        {
            return self::classSummary(self::$sid);
        }

        public static function classSummary($sid)
        {
